...
## Domain Purpose
Represents a valid IP address (IPv4 or IPv6).

## Canonical Value Model
- Backing representation: `IPAddress` value.
- Canonical string representation: Normalized textual representation from `IPAddress`.
- Equality/comparison basis: Underlying parsed address.
...
- Required scenario IDs for traceability:
  - IPADDRESS-CONSTRUCT-001
  - IPADDRESS-PARSE-001
  - IPADDRESS-TRYPARSE-001
  - IPADDRESS-FORMAT-001
  - IPADDRESS-CONVERT-001
