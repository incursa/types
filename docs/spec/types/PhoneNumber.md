...
workbench:
  ...
  codeRefs: []
  pathHistory:
    - "/C:/docs/spec/types/PhoneNumber.md"
  path: /docs/spec/types/PhoneNumber.md
---

# PhoneNumber Behavioral Specification
...
## Domain Purpose
Represents a normalized E.164 telephone number and region metadata.

## Canonical Value Model
- Backing representation: Parsed phone number with region metadata.
- Canonical string representation: E.164 format (for example `+14155552671`).
- Equality/comparison basis: Normalized E.164 value.
...
- Required scenario IDs for traceability:
  - PHONENUMBER-CONSTRUCT-001
  - PHONENUMBER-PARSE-001
  - PHONENUMBER-TRYPARSE-001
  - PHONENUMBER-FORMAT-001
  - PHONENUMBER-CONVERT-001
