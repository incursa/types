...
workbench:
  ...
  codeRefs: []
  pathHistory:
    - "/C:/docs/spec/types/UsaState.md"
  path: /docs/spec/types/UsaState.md
---

# UsaState Behavioral Specification
...
## Domain Purpose
Represents a valid US state/territory code in the provided domain model.

## Canonical Value Model
- Backing representation: Static enumerated state value object.
- Canonical string representation: Two-letter uppercase state code.
- Equality/comparison basis: State code identity.
...
- Required scenario IDs for traceability:
  - USASTATE-CONSTRUCT-001
  - USASTATE-PARSE-001
  - USASTATE-TRYPARSE-001
  - USASTATE-FORMAT-001
  - USASTATE-CONVERT-001
